...
if($resultsqlq31)
{
	...
	<li>
		  	<span class="navbar-text"><strong>XYZ-Learning Management System</strong></span></li><li><span class="navbar-text">'.$row['Email'].'</span></li><li><img src="data:image/jpeg;base64,'.base64_encode($row['Image_Data']).'" class="img-thumbnail" style="height:40px;width:40px;"></li><li><a href="../logout.php"><button class="btn btn-primary col col-xs-12 col-sm-12 col-md-12 col-lg-12">Logout</button></a></li></ul>
	</nav>';
}
}
elseif (!$resultsqlq31) {
