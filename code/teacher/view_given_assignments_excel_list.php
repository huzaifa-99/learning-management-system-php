...
// set cell value
$sqlquerye1 = "SELECT * FROM assignments_project2 WHERE Course_No='{$_SESSION['course']}' AND Semester_No='{$_SESSION['semester']}' AND Assignment_No='$assignid' ORDER BY Student_ID ASC";
...
/*****writing from here********/
/** Point X0 **/	
$name = $_SESSION['course']."-AssignNo(".$assignid.")List"."-Semester".$_SESSION['semester'];
