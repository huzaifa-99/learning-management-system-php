...
if (isset($_GET['id'])) {
		...
		elseif(mysqli_num_rows($result)==1){
			...
			header("Content-type: application/pdf");//application/octet-stream" for both word and pdf
			header("Content-Disposition: attachment; filename=$assignname");// attachment for download and inline for in page
			header("Expires: 0");
